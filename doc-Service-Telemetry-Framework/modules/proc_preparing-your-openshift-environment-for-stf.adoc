...
* Ensure that persistent storage is available in your {OpenShift} cluster so that you can store data in a production system. For more information, see <<persistent-volumes>>.
