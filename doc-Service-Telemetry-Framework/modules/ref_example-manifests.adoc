...
Ensure that the `name` and `amqp_url` parameters of each Smart Gateway match the names that you want to use for your clouds. For more information, see <<planning-amqp-address-prefixes_advanced-features>>.
