...
kind: SmartGateway
metadata:
  name: stf-default-ceilometer-telemetry-cloud1  <3>
spec:
  amqpDataSource: ceilometer
  amqpUrl: stf-default-interconnect.service-telemetry.svc.cluster.local:5673/anycast/ceilometer/cloud1-metering.sample  <4>
  debug: false
  prefetch: 15000
  serviceType: metrics
  size: 1
...
kind: SmartGateway
metadata:
  name: stf-default-collectd-notification-cloud1  <5>
spec:
  amqpDataSource: collectd
  amqpUrl: stf-default-interconnect.service-telemetry.svc.cluster.local:5672/collectd/cloud1-notify  <6>
  debug: false
  elasticPass: fkzfhghw......
  elasticUrl: https://elasticsearch-es-http.service-telemetry.svc.cluster.local:9200
  elasticUser: elastic
...
kind: SmartGateway
metadata:
  name: stf-default-collectd-telemetry-cloud1 <7>
spec:
  amqpUrl: stf-default-interconnect.service-telemetry.svc.cluster.local:5672/collectd/cloud1-telemetry  <8>
  debug: false
  prefetch: 15000
  serviceType: metrics
  size: 1
...
<3> Name for Ceilometer telemetry for `cloud1`
<4> AMQP Address for Ceilometer telemetry for `cloud1`
<5> Name for collectd telemetry for `cloud1`
<6> AMQP Address for collectd telemetry for `cloud1`
<7> Name for collectd notifications for `cloud1`
<8> AMQP Address for collectd notifications for `cloud1`
