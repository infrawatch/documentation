...
//[OSP16.1.3+ ONLY] 
[NOTE]
If you have enabled Container health and API stats monitoring, you must also modify the `CollectdSensubilityResultsChannel` parameter. For more information, see xref:planning-amqp-address-prefixes_advanced-features[].
