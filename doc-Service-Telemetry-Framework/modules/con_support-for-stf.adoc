...
{ProjectShort} only works in a fully connected network environment. {ProjectShort} does not work in {OpenShift} disconnected environments or network proxy environments.
