...
You need an OperatorGroup in the namespace to permit scheduling of the Operator pods. Run the following command:
...
Before you deploy {ProjectShort} on {OpenShift}, complete the following steps:
