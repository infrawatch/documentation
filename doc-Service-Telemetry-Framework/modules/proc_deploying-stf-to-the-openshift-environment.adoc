...
. If you plan to store metrics in Prometheus, you must enable the Prometheus Operator. To enable the Prometheus Operator, subscribe by using the community-operators CatalogSource:
+
[WARNING]
====
...
openshift-cert-manager.v1.7.1                 cert-manager Operator for Red Hat OpenShift   1.7.1-1                                                             Succeeded
prometheusoperator.0.56.3                     Prometheus Operator                           0.56.3                prometheusoperator.0.47.0                     Succeeded
service-telemetry-operator.v1.5.1678301890    Service Telemetry Operator                    1.5.1678301890                                                      Succeeded
smart-gateway-operator.v5.0.1678301890        Smart Gateway Operator                        5.0.1678301890                                                      Succeeded
----
