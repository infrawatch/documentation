...
= Installing the Service Telemetry Framework v1.5 Operators

Install the Service Telemetry Framework (STF) v1.5 Operators and the Certificate Manager for OpenShift Operator on your Red Hat OpenShift Container Platform v4.10 environment. STF v1.5 only supports Red Hat OpenShift Container Platform v4.10. Installing STF into disconnected or restricted network environments is unsupported.

[NOTE]
After a successful STF v1.5 install, you must retrieve and apply the AMQ Interconnect CA certificate to the RHOSP environment, or the transport layer and telemetry data becomes unavailable.

For more information about updating the AMQ Interconnect CA certificate, see xref:updating-the-amq-interconnect-ca-certificate-on-red-hat-openstack-platform_upgrading-service-telemetry-framework-to-version-1-5[].

.Prerequisites

* You have upgraded your Red Hat OpenShift Container Platform environment to v4.10.
For more information about upgrading Red Hat OpenShift Container Platform, see xref:upgrading-red-hat-openshift-container-platform-to-v4-10_upgrading-service-telemetry-framework-to-version-1-5[].
