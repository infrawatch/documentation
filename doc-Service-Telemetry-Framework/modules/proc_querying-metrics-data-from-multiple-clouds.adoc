...
To query data from a specific cloud, use a Prometheus `promql` query that matches the associated _service_ label; for example: `collectd_uptime{service="stf-default-collectd-telemetry-cloud1-smartgateway"}`.
