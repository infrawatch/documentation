...
To query data from a specific cloud, use a Prometheus `promql` query that matches the associated "service" label; for example: `collectd_uptime{service="cloud1-smartgateway"}`.
