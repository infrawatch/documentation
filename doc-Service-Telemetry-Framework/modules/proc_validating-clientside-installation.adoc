...
----
$ oc exec -it deploy/stf-default-interconnect -- qdstat --connections
...
Connections
  ...
  4   10.130.0.37:45154  rcv[stf-default-ceilometer-telemetry-smartgateway-6c99864b45-fwqfc]   edge    in   no-security                             anonymous-user          000:00:00:02  006:21:34:45
...
[source,bash,options="nowrap"]
----
$ oc exec -it deploy/stf-default-interconnect -- qdstat --address
