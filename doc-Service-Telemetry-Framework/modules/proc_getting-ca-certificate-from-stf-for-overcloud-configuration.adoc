...
[role="_abstract"]
To connect your {OpenStack} ({OpenStackShort}) overcloud to {Project} ({ProjectShort}), retrieve the CA certificate of {MessageBus} that runs within {ProjectShort} and use the certificate in the {OpenStackShort} configuration.
