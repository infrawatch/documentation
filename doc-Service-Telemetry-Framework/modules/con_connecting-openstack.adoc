...
To deploy data collection and transport to {ProjectShort} on {OpenStack} cloud nodes that employ routed L3 domains, such as distributed compute node (DCN) or spine-leaf, see <<deploying-with-routed-l3-networks_completing-the-stf-configuration>>.
