...
----
+
TIP: You can set the admin username and password through the `ServiceTelemetry` object using `graphing.grafana.adminUser` and `graphing.grafana.adminPassword` parameters.
