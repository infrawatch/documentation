...
* Your environment is fully connected. {ProjectShort} does not work in Red Hat OpenShift Container Platform-disconnected environments or network proxy environments.
