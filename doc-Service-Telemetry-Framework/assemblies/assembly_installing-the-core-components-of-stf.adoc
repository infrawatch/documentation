...
[WARNING]
{OpenShift} version 4.3 is currently required for a successful installation of {ProjectShort}. The release of Smart Gateway Operator 1.0.2 will result in support of {OpenShift} version 4.4 and later.
endif::[]
