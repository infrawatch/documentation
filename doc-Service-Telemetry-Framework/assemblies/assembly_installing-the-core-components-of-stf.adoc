...
[IMPORTANT]
{ProjectShort} is compatible with {OpenShift} 4.8.
endif::[]

.Additional resources

* For more information about Operators, see the https://docs.openshift.com/container-platform/4.8/operators/understanding/olm-what-operators-are.html[_Understanding Operators_] guide.
