...
* You can install {OpenShift} on bare metal or other supported cloud platforms. For more information about installing {OpenShift}, see https://docs.openshift.com/container-platform/4.8/welcome/index.html#cluster-installer-activities[OpenShift Container Platform 4.8 documentation].
