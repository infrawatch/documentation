...
The components of {ProjectShort} use a message bus for reliable data transport. Other modular components that receive and store data are deployed in containers on {OpenShift}.
