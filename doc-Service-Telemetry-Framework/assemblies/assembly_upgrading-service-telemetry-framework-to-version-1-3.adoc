...
* You have upgraded your {OpenShift} environment to {SupportedOpenShiftVersion}. {ProjectShort} 1.3 does not run on {OpenShift} 4.5 and lower.{ProjectShort} 1.2 does not run on {OpenShift} 4.7 and higher.
